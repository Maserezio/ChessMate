package chessmate.player;

import chessmate.board.Alliance;
import chessmate.board.Board;
import chessmate.board.BoardUtils;
import chessmate.board.Move;
import chessmate.board.Move.KingSideCastleMove;
import chessmate.board.Move.QueenSideCastleMove;
...
import static chessmate.pieces.Piece.PieceType.ROOK;
    ...
    protected Collection<Move> calculateKingCastles(final Collection<Move> playerLegals, final Collection<Move> opponentLegals) {
        ...
        if (this.playerKing.isFirstMove() && this.playerKing.getPiecePosition() == 4 && !this.isInCheck) {
            if (this.board.getPiece(5) == null && this.board.getPiece(6) == null) {
                ...
                if (kingSideRook != null && kingSideRook.isFirstMove() && Player.calculateAttacksOnTile(5, opponentLegals).isEmpty() 
